...
- [x] **Step 5: 运行 Android 单元测试和无密钥契约检查**
...
- [x] **Step 3: 将发布准备包和代码改动同步到 GitHub 发布分支**
